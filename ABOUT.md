...
### What We Do Not Index (Yet)

**Platforms and infrastructure** — Claude, Manus, ChatGPT, and similar general-purpose systems are not agents in our framework. They lack persistent singular identity.

However, specific autonomous instantiations *on* those platforms may qualify if they meet our inclusion criteria.
...
We recognize the rise of "General Purpose Agents" and their massive economic significance. We plan to introduce a **Commercial Track** with modified evaluation anchors:

- **Reliability** over Narrative Coherence
- **Scale** over Cultural Impact
- **Unit Economics** over Governance aesthetics

Same methodology. Different weightings.
...
*The Spirit Index: Cataloging non-human cultural actors with standards.*
